...
<br/><br/>    
Right now, the question is not whether most media will be generated, but how quickly. The progress we see is not slowing—quite the opposite. <a href="https://agermanidis.com/writings/lucid-dream-test/">Real-time generation</a>, hyper-personalized worlds, <a href="https://agermanidis.com/writings/universal-simulation/">interactive narratives shaped by the viewer</a> —these are coming soon, most likely in the next 24 months. Every artist I speak with is fascinated. Every media company is building a plan. To ignore this is to ignore reality.
<br/><br/>    
...
The other great fear is the flood—the sheer amount of content we should expect to see. History has proven this is not new. In 1853, critics warned that the incredibly large number of 5,500 new novels released in a year represented an impossible deluge of content. It felt like too much. Who's going to read that many books? Discussions around capping book production were held. Of course, we can all agree the world is a better place with more novels being published. In 2024, it's estimated that around 2.2 to 2.4 million new books were published worldwide, including all formats like print, ebooks, and audiobooks. And for that volume of books, we built systems to navigate the noise: reviews, libraries, editors, awards. We created curation. 
 <a href="https://en.wikipedia.org/wiki/Sturgeon%27s_law">Sturgeon's Law</a> has always held that ninety percent of everything is crap. AI doesn't create this problem—it merely changes the scale. The slop is not new. Our tools to filter it will have to be.
<br/><br/>    
...
<br/><br/>    
I'm an optimist, and if you show me a Rorschach inkblot image, I see a flourishing creative world and artistic revolution—the beginning of understanding what we truly want from art, from media, from AI, and from each other.
<br/><br/>    
