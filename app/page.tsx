    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24 xs:p-10 sm:p-16">
      ...
      <div className="z-10 w-full max-w-5xl items-center justify-between text-sm lg:flex">
        <ul className={`m-0 text-sm opacity-70 posts`}>
          ...
          <li><a href="/encode">On Encoding and Decoding</a></li>
          <li><a href="/care">You Have to Care</a></li>
          <li><a href="/extremes">Value Accrues to the Extremes</a></li>
      ...
      <div className="z-10 w-full max-w-5xl items-center justify-between text-sm lg:flex">
        <p className={`m-0 text-sm opacity-60 xs:pb-6 sm:pb-5`}>
         c [at] runway.com - <a href="https://twitter.com/c_valenzuelab">Twitter</a> - <a href="https://www.linkedin.com/in/cvalenzuelab/">Linkedin</a> - <a href="https://github.com/cvalenzuela">Github</a>
        </p>
      </div>
